			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-8">
					...
					<div class="card ">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>giris/daftar" method="post">
								<div class="form-group">
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" name="name" class="form-control" required=""
												placeholder="Adı-Soyadı" value="<?php echo set_value('name') ?>">
								...
								<div class="form-group">
									<div class="form-label-group">
										<textarea class="form-control" placeholder="Adres"
							...
							<div class="text-center">
								<p>Kayıtlı mısın? <a class="" href="<?php echo base_url() ?>giris">Giriş Yap</a>
								</p>
							</div>
						</div>
					</div>
