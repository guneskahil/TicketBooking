<html lang="tr" moznomarginboxes mozdisallowselectionprint>
...
<body onload="window.print()">
    ...
    <td><img src="<? php// echo base_url().'assets/img/kop_surat.png' ?>"/></td>
        ...
        <table border="1" align="center" class="table table-bordered table-striped"
            ...
            <thead>
                <tr>
                    <th colspan="11" style="text-align:left;">Report From Date:
                        <?php echo $mulai ?> to
                        <?php echo $sampai ?>
                    </th>
                </tr>
                ...
                <?php foreach ($laporan as $row) { ?>
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <?php echo '$' . number_format($row['harga_tiket']); ?>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
