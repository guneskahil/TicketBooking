						...
						<tbody>
							...
							foreach ($bank as $row) { ?>
								<tr>
									...
									<td align="center"><a href="<?= base_url('backend/banka/viewbank/' . $row['kd_banka']) ?>"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?= base_url() ?>backend/banka/tambahbank" method="post" enctype="multipart/form-data">
