  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Booking Code [
          <?= $konfirmasi[0]['kd_siparis']; ?>]
        </h6>
      </div>
      <div class="card-body">
              ...
              <?php foreach ($konfirmasi as $row) { ?>
                <div class="col-sm-6">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kd_onaylama" value="<?= $row['kd_onaylama'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama" value="<?= $row['isim_banka_onaylama'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="harga" value="<?php echo $row['hesapno_onaylama'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="tgl_beli" value="<?= $row['toplam_onaylama'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <img id="myImg" src="<?= base_url($row['resim_onaylama']) ?>" alt="<?= $row['isim_onaylama'] ?>"
